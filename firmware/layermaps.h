// created by antonok's kb layout manager on Fri Mar 16 2018
...
{NONE,NONE,NONE,FUNC(targetLayer_COLEMAK),NONE,NONE,NONE,FUNC(targetLayer_MIDI),NONE,NONE,NONE,NONE,HID(_PAGE_UP),NONE},
...
{MOD(_MOD_LEFTCTRL),MOD(_MOD_LEFTGUI),MOD(_MOD_LEFTALT),FUNC(toggleLayer_FN),MOD(_MOD_LEFTSHIFT),NONE,NONE,HID(_SPACE),NONE,NONE,NONE,HID(_LEFT_ARROW),HID(_DOWN_ARROW),HID(_RIGHT_ARROW)}};
...
{MOD(_MOD_LEFTCTRL),MOD(_MOD_LEFTGUI),MOD(_MOD_LEFTALT),NONE,MOD(_MOD_LEFTSHIFT),NONE,NONE,NONE,NONE,NONE,FUNC(toggleLayer_MOUSE),MOUSE_X(-9),MOUSE_Y(9),MOUSE_X(9)}};
