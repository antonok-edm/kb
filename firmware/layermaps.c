...
{HID(_BACKSPACE),NONE,NONE,NONE,HID(_GRAVE_ACCENT_AND_TILDE),NONE,NONE,HIDMOD(_GRAVE_ACCENT_AND_TILDE,_MOD_LEFTSHIFT),NONE,NONE,NONE,NONE,NONE,HID(_DELETE)},
{NONE,HIDMOD(_9_OPENING_PARENTHESIS,_MOD_LEFTSHIFT),HIDMOD(_0_CLOSING_PARENTHESIS,_MOD_LEFTSHIFT),HID(_OPENING_BRACKET_AND_BRACE),HID(_CLOSING_BRACKET_AND_BRACE),HIDMOD(_OPENING_BRACKET_AND_BRACE,_MOD_LEFTSHIFT),HIDMOD(_CLOSING_BRACKET_AND_BRACE,_MOD_LEFTSHIFT),HIDMOD(_EQUAL_AND_PLUS,_MOD_LEFTSHIFT),HID(_EQUAL_AND_PLUS),HID(_MINUS_AND_UNDERSCORE),HIDMOD(_MINUS_AND_UNDERSCORE,_MOD_LEFTSHIFT),HID(_ENTER),HID(_VOLUME_UP),NONE},
{NONE,NONE,NONE,NONE,NONE,NONE,TOGGLE(LRDN),NONE,NONE,NONE,NONE,HID(_VOLUME_DOWN),HID(_VOLUME_DOWN),HID(_VOLUME_UP)}};
